...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-dr0tnfg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-dr0tnfg.containers.anotherwebservice.com/
...
```
git clone git@github.com:drmrok/container-dr0tnfg.git
cd container-dr0tnfg
```
...
```
docker attach container-dr0tnfg
```
